...
//             className="mt-8 p-8 bg-black/70 rounded-xl shadow-lg max-w-md w-full"
//           >
...
//               value={email}
//               onChange={(e) => setEmail(e.target.value)}
//               className="w-full border bg-white rounded-full px-10 py-2 focus:outline-none focus:ring-2 focus:ring-red-400 text-center mb-4"
//               placeholder="Email"
//               required
//             />
...
//               type="submit"
//               disabled={isLoading}
//               className="w-full mt-6 px-8 py-3 bg-red-600 hover:bg-red-800 text-white font-semibold rounded-full shadow-lg transition"
//             >
//               {isLoading ? "Logging in..." : "Login"}
//             </button>

//             <Link href="/register">
//               <p className="mt-8 text-gray-300 hover:text-white underline cursor-pointer">
//                 Don't have an account? Register here.
//               </p>
//             </Link>
//           </form>
...
//                   <div className="m-4 rounded-lg w-55 hover:scale-105 transition-transform">
//                     <img
//                       src={movie.img}
//                       alt={movie.title}
//                       className="bg-white p-0.5 rounded-md mb-3 w-full h-80 object-cover"
//                     />
//                   </div>
//                 </Link>
//               </SwiperSlide>
